...
func NewKibanaTopology(in *models.KibanaClusterTopologyElement) (*KibanaTopology, error) {
	var top KibanaTopology
...
func NewKibanaTopologies(in []*models.KibanaClusterTopologyElement) ([]KibanaTopology, error) {
	if len(in) == 0 {
		return nil, nil
	}

	tops := make([]KibanaTopology, 0, len(in))
