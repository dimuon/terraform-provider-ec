	...
	tests := []struct {
		...
		},
		{
			...
			args: args{
				...
				template:     parseDeploymentTemplate(t, "testdata/template-aws-hot-warm-v2.json"),
		...
		},
		{
			...
			args: args{
				...
				template:     parseDeploymentTemplate(t, "testdata/template-ece-3.0.0-default.json"),
				templateID:   "aws-io-optimized-v2",
				version:      "7.17.3",
				useNodeRoles: true,
			},
