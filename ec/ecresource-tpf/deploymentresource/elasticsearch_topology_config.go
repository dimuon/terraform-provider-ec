...
func (cfgs *ElasticsearchTopologyConfigs) fromModel(in *models.ElasticsearchConfiguration) error {
	var cfg ElasticsearchTopologyConfig
	cfg.fromModel(in)

	if !cfg.isEmpty() && (*cfgs) == nil {
		*cfgs = make(ElasticsearchTopologyConfigs, 1)
		(*cfgs)[0] = cfg
	}
	return nil
}
...
func (c *ElasticsearchTopologyConfig) fromModel(in *models.ElasticsearchConfiguration) error {
	if in == nil {
		return nil
	}
