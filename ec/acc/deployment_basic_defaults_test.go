		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resName, "elasticsearch.hot_content_tier.size", "8g"),
					resource.TestCheckResourceAttr(resName, "elasticsearch.hot_content_tier.size_resource", "memory"),
					resource.TestCheckResourceAttrSet(resName, "elasticsearch.hot_content_tier.node_roles.#"),
					resource.TestCheckResourceAttr(resName, "elasticsearch.hot_content_tier.zone_count", "2"),
					resource.TestCheckResourceAttrSet(resName, "kibana.topology.instance_configuration_id"),
					...
					resource.TestCheckResourceAttrSet(resName, "enterprise_search.topology.instance_configuration_id"),
					...
					resource.TestCheckResourceAttr(resName, "enterprise_search.topology.zone_count", "1"),
				),
			},
			{
				// Add an APM resource.
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resName, "kibana.topology.size_resource", "memory"),
					resource.TestCheckResourceAttr(resName, "kibana.topology.zone_count", "1"),
					resource.TestCheckResourceAttrSet(resName, "apm.topology.instance_configuration_id"),
					resource.TestCheckResourceAttr(resName, "apm.topology.size_resource", "memory"),
					resource.TestCheckResourceAttr(resName, "apm.topology.zone_count", "1"),
					resource.TestCheckResourceAttrSet(resName, "enterprise_search.topology.instance_configuration_id"),
					resource.TestCheckResourceAttr(resName, "enterprise_search.topology.size", "2g"),
					resource.TestCheckResourceAttr(resName, "enterprise_search.topology.size_resource", "memory"),
					resource.TestCheckResourceAttr(resName, "enterprise_search.topology.zone_count", "1"),
	...
	resource.ParallelTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			},
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					resource.TestCheckResourceAttrSet(resName, "elasticsearch.hot_content_tier.instance_configuration_id"),
					resource.TestCheckResourceAttrSet(resName, "elasticsearch.warm_tier.instance_configuration_id"),
					// Hot Warm defaults to 4g.
					resource.TestCheckResourceAttr(resName, "elasticsearch.hot_content_tier.size", "4g"),
					resource.TestCheckResourceAttr(resName, "elasticsearch.hot_content_tier.size_resource", "memory"),
					resource.TestCheckResourceAttr(resName, "elasticsearch.warm_tier.size", "4g"),
					resource.TestCheckResourceAttr(resName, "elasticsearch.warm_tier.size_resource", "memory"),
					resource.TestCheckResourceAttrSet(resName, "elasticsearch.hot_content_tier.node_roles.#"),
					resource.TestCheckResourceAttr(resName, "elasticsearch.hot_content_tier.zone_count", "2"),
					resource.TestCheckResourceAttrSet(resName, "elasticsearch.warm_tier.node_roles.#"),
					resource.TestCheckResourceAttr(resName, "elasticsearch.warm_tier.zone_count", "2"),
					resource.TestCheckResourceAttr(resName, "kibana.topology.size", "1g"),
					resource.TestCheckResourceAttrSet(resName, "kibana.topology.instance_configuration_id"),
					resource.TestCheckResourceAttr(resName, "kibana.topology.size_resource", "memory"),
					resource.TestCheckResourceAttr(resName, "kibana.topology.zone_count", "1"),
