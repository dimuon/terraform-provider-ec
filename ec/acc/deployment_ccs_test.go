		...
		Steps: []resource.TestStep{
			...
			},
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttrSet(ccsResName, "elasticsearch.hot.node_roles.#"),
					resource.TestCheckResourceAttr(ccsResName, "elasticsearch.hot.zone_count", "1"),
					resource.TestCheckResourceAttr(ccsResName, "kibana.topology.zone_count", "1"),
					resource.TestCheckResourceAttrSet(ccsResName, "kibana.topology.instance_configuration_id"),
					resource.TestCheckResourceAttr(ccsResName, "kibana.topology.size", "1g"),
					resource.TestCheckResourceAttr(ccsResName, "kibana.topology.size_resource", "memory"),
