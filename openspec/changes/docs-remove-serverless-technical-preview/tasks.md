...
- [ ] 2.1 Run `env -u TF_ACC make docs-generate` and verify `docs/resources/elasticsearch_project.md`, `docs/resources/observability_project.md`, and `docs/resources/security_project.md` no longer contain the Technical preview heading or the two disclaimer sentences.
